...
To buld a design vocabulary among our users, first we need strong examples and documentation. But also, the functions, utilities, and architecture of Bokeh should be designed in a way that helps developers understand the outcomes of their design decisions. There should be _vocabulary correspondance_ between the concepts we want people to envision and how the API is actually used.
